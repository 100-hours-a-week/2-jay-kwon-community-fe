document.addEventListener('DOMContentLoaded', () => {
    ...
    if (post) {
        ...
        document.getElementById('post-likes').textContent = formatter.formatCount(heartsForPost.length);

        // 댓글 수
        const commentsForPost = commentsAPI.getCommentsByPost(post.pno);
        document.getElementById('post-comments').textContent = formatter.formatCount(commentsForPost.length);
